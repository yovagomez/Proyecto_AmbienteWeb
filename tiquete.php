<?php
    ...
    $queryTiquetes = "CALL ConsultarTiquetes('-1')";
    $respuestaTiquetes = $AbiertaDB -> query($queryTiquetes);

    if(isset($_POST['btnNuevoTiquete'])){
        header("Location: nuevoTiquete.php");
    }
...
<body style="background: #bababa">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark scrolling-navbar fixed-top">
        ...
        <a class="navbar-brand" style="color: white;">TIQUETE</a>
    ...
    <form action="" method="post">
        ...
        <div class="container-fluid">
            ...
            <table class="table table-bordered" style="text-align: center;">
                ...
                <tbody>
                    ...
                    <?php
                                while($fila = mysqli_fetch_array($respuestaTiquetes))
                                {
                                 echo "<tr>";
                                 echo "<td>" . $fila['idTiquete'] . "</td>";
        ...
        <div class="col text-center">
            <input type="submit" class="btn btn-primary" value="Nuevo Tiquete" name="btnNuevoTiquete"></input>
            <br /><br />
        </div>
